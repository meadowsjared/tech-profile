  ...
  return (
    <div className={styles.experience}>
      ...
      <div>
        ...
        expertise lies in Vue, Angular, and TypeScript, coupled with a strong
        foundation in HTML, CSS, SCSS, and JavaScript. This diverse skill set
        has enabled me to build robust and efficient web applications across
